...
passport.use(
  new LocalStrategy(function (username, password, done) {   
    db.findByUsername(username, async (err, user) => { // Look up user in the db  
...
passport.deserializeUser((id, done) => {  
  db.findById(id, function (err, user) { // id -який використовується для пошуку користувача в Базі Даних
